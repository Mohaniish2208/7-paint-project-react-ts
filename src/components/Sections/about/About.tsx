    ...
    <div className="story-container">
      <div className="section-main-container">
        ...
        <div className="section">
          <p className="name">From Saltwater to Paintbrush</p>
          <p className="story">
        ...
        <div className="section">
          <p className="name">Finding My Way to Toronto</p>
          <p className="story">
        ...
        <div className="section">
          <p className="name">Always Came Back to the Brush</p>
          <p className="story">
        ...
        <div className="section">
          <p className="name">More Than Just Painting</p>
          <p className="story">
        ...
        <div className="section">
          <p className="name">Built on Trust and Craftsmanship</p>
          <p className="story">
        ...
        <div className="section">
          <p className="name">The Best Part of the Job</p>
          <p className="story">
